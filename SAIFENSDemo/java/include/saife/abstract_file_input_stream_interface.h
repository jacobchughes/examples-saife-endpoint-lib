 ...
 */
#ifndef INCLUDE_SAIFE_ABSTRACT_FILE_INPUT_STREAM_INTERFACE_H_
#define INCLUDE_SAIFE_ABSTRACT_FILE_INPUT_STREAM_INTERFACE_H_
...
/**
 * Input stream interface for reading from a {@link saife::AbstractFileInterface AbstractFileInterface}
 */
class AbstractFileInputStreamInterface {
 public:

  /**
   * Destructor
   */
  virtual ~AbstractFileInputStreamInterface() {
   ...
   * @throws {@link saife::io::IOException IOException} If there is an I/O error
   */
  virtual int Read(std::vector<uint8_t>* buffer_ptr) = 0;
   ...
   * @throws {@link saife::io::IOException IOException} If there is an I/O error
   */
  virtual int Read(std::vector<uint8_t>* buffer_ptr, const std::size_t offset, const std::size_t length) = 0;
   ...
   *
   * This method may skip more bytes than are remaining in the backing file. This produces no exception and the number
 ...
 protected:
   ...
   * Constructor
   */
  AbstractFileInputStreamInterface() {
...
#endif  // INCLUDE_SAIFE_ABSTRACT_FILE_INPUT_STREAM_INTERFACE_H_
